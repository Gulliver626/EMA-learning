          ...
          <div class="col">
            <div data-aos="zoom-in-left" class="card shadow-sm h-100">
              <svg class="bd-placeholder-img card-img-top" width="100%" height="80" xmlns="http://www.w3.org/2000/svg"
                ...
                <rect width="100%" height="100%" fill="<?php echo $row['color'] ?>" /><text x="50%" y="50%"
                  fill="#eceeef" dy=".3em">
                  <?php echo $row['nombre'] ?>
                </text>
              </svg>
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    <a href="cursos/<?php echo $row['nombre'] ?>.php"><input class="btn btn-sm btn-outline-success"
                        type="button" value="Ver curso"></a>
                    <button type="button" class="btn btn-sm btn-outline-danger"><i class="fas fa-heart"></i></button>
                  </div>
